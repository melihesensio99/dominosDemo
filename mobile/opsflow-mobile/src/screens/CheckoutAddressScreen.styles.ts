...
export const styles = StyleSheet.create({
  ...
  sectionHeader: { paddingHorizontal: 4, gap: 4 },
  emptyText: { color: theme.colors.muted, paddingHorizontal: 4 },
  selectedText: { color: theme.colors.primary, fontWeight: '800', marginTop: 8 },
